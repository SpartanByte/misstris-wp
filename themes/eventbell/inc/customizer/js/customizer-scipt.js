...
( function( $, api ) {
    ...
    api.controlConstructor['eventbell-repeater-text'] = api.Control.extend({
        ...
        // upsell 
    api.sectionConstructor['eventbell-upsell'] = api.Section.extend( {
...
*/
 jQuery(document).ready(function($) {
    $('#eventbell-img-container li label img').click(function(){      
        $('#eventbell-img-container li').each(function(){
            $(this).find('img').removeClass ('eventbell-radio-img-selected') ;
        });
        $(this).addClass ('eventbell-radio-img-selected') ;
    }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', eventbell_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', eventbell_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', eventbell_customize_multi_remove_field )
    ...
    function eventbell_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            eventbell_customize_multi_write( $control );
    }

    function eventbell_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        eventbell_customize_multi_write( $control );
    }

    function eventbell_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function eventbell_customize_multi_write( $element) {
 ...
 jQuery(document).ready(function($) {
    $('#customize-control-theme_options-layout_options_blog #eventbell-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #eventbell-img-container li').each(function(){
            $(this).find('img').removeClass ('eventbell-radio-img-selected') ;
        });
        $(this).addClass ('eventbell-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #eventbell-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #eventbell-img-container li').each(function(){
            $(this).find('img').removeClass ('eventbell-radio-img-selected') ;
        });
        $(this).addClass ('eventbell-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #eventbell-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #eventbell-img-container li').each(function(){
            $(this).find('img').removeClass ('eventbell-radio-img-selected') ;
        });
        $(this).addClass ('eventbell-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #eventbell-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #eventbell-img-container li').each(function(){
            $(this).find('img').removeClass ('eventbell-radio-img-selected') ;
        });
        $(this).addClass ('eventbell-radio-img-selected') ;
    });                 
