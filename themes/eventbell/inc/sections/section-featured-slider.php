 ...
 */
    ...
    $slider_category = eventbell_get_option( 'slider_category' );
    $image_overlay   = eventbell_get_option( 'disable_white_overlay' );
    $class ='';
    ?>
                        ...
                        <article class="slick-item" style="background-image: url('<?php the_post_thumbnail_url( 'full' ); ?>');">
                            ...
                            <div class="wrapper">
                                <div class="<?php echo esc_attr($class); ?> featured-content-wrapper">
                                    ...
                                    <?php
                                    $readmore_text   = eventbell_get_option( 'slider_custom_btn_text_' . $i ); 
